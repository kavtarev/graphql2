...
export const FloatHeaderTemplate = ({isScroll,isArticle}:Props) => {
    
    return (
        <header className={`app-header ${isArticle && 'header-index'} header-rubric-post isWindows `}>
            <div className={`header-container `}>
                <div className="header-row">
                    <a href="/" className="header-row-search">
                        <svg viewBox="0 0 20 20" className="origin">
                            <g fill="none" stroke={`${!isArticle?'#fff':'#000'}`}>
                                <circle cx="8" cy="9" r="7.25"></circle>
                                <path fill={`${!isArticle?'#fff':''}`}d="M13 14l4 4"></path>
                            </g>
                        </svg>{' '}
                    ...
                    <div>
                    <div className={`header-logo-wrap  ${!isScroll? '':'onlyString'}`}>
                    ...
                    <div className={`header-logo-wrap bigF ${isScroll? '':'onlyF'}`}>
                        <a
                            href="/"
                            aria-current="page"
                            className="header-logo nuxt-link-exact-active nuxt-link-active"
                        >
                            <svg
                                viewBox="0 0 22 40"
                    ...
                    <div className="hamburger">
                        <svg viewBox="0 0 20 20" className="origin">
                            <path fill={`${!isArticle?'#fff':''}`} d="M0 3h20v1.5H0zm0 12.5h20V17H0z"></path>
                        </svg>{' '}
                        <svg viewBox="0 0 20 20" className="doubled">
                            <path fill={`${!isArticle?'#fff':''}`} d="M0 3h20v1.5H0zm0 12.5h20V17H0z"></path>
                        </svg>
